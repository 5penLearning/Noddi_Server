    ...
    public OpenAiResponseDto.MeetingSummary summarizeText(
        ...
        try {
            ...
            String systemPrompt = """
                    ...
                    주요 이슈(issues) 추출 규칙:
                    - 주요 이슈는 회의에서 현재 문제로 언급된 오류, 장애, 지연, 위험, 우려 사항, 제약 사항, 미해결 쟁점이다.
        ...
        return Map.of(
                ...
                "properties", Map.of(
                        ...
                        "issues", Map.of(
                                ...
                                "description",
                                """
                                회의에서 현재 문제로 언급된 오류, 장애, 지연, 위험, 우려 사항,
                                제약 사항 또는 미해결 쟁점 목록.
                                담당자나 해결 업무가 정해져 actionItems에 포함되더라도
                                문제 자체는 issues에도 포함할 수 있다.
                                이미 해결된 문제와 단순 의견·일정·결정사항은 제외한다.
                                """,
                                "items", Map.of(
                                        "type", "string",
